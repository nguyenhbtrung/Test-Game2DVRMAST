...
{
    public class HitboxBehaviorTestsBase
    {
        protected const float positionThreshold = 0.1f;
        protected List<ActionSequence> sequences;
        ...
        protected void HideTraps(bool exceptNoDamage = false)
        {
            if (exceptNoDamage)
            {
        ...
        protected void HideMovingPlatforms()
        {
        ...
        protected void LoadSimulatorInputData(string jsonFileName)
        {
        ...
        protected void ProcessPlayerAction(dichuyen2 playerMovement, InputActionData actionData)
        {
...
//    {
//        if (TestHelper.ShouldSkipTest(nameof(TestIsGroundedStatusBeforeAndAfterJump)))
//        {
//            Assert.Ignore();
//        }
//        string logFileName = TestSettings.TestLogFileName;
